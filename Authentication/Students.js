...
export default class Students extends React.Component {
  ...
  login = () => {
   ...
   return;  
    ...
    str = "https://cts-server.herokuapp.com/login/s?"+"email="+e+"&pin="+p;
...
getPin = () => {
 ...
 return;  
  ...
  str = "https://cts-server.herokuapp.com/login/s?"+"email="+e;
      ...
      .then((jsonData) => {
        console.log(jsonData);
          if(jsonData == "failed"){
              ...
              Alert.alert("Failed","Probably server is down, please try sometime later");
            ...
            Alert.alert(" Auth Failure","Wrong Credentials");
