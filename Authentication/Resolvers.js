...
export default class Login extends React.Component {
  ...
  login = () => {
   ...
   let str = "https://cts-server.herokuapp.com/login/r?"+"email="+e+"&pin="+p;
    ...
    fetch(str, {
        ...
        .then((jsonData) => {
          console.log(jsonData);
           ...
           this.props.navigation.navigate('ResolverDash');
...
getPin = () => {
 ...
 return;  
  ...
  str = "https://cts-server.herokuapp.com/login/r?"+"email="+e;
